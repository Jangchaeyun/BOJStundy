...
public class B3062 {
    public static void main(String[] args) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(System.out)); // 산언
        ...
        for (int i = 0; i < N; i++) { // 건수만큼 반복
            ...
            for (int j = numSet.length() - 1; j >= 0; j--) { // 뒤잡은 값 생성
            ...
            for (int j = 0; j < (sumSet.length() / 2); j++) { // 중간까지만 감사
